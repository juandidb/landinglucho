        ...
        <div style={{ marginTop: 'calc(36vh - 3px)' }} className="grid gap-12 lg:grid-cols-1 place-items-center text-center">
          <div className="max-w-3xl">
            <h1
              ...
              style={{ marginTop: '-5px' }}
            >
              Exactitud en cada medición. Seguridad en cada proyecto.
            </h1>
            <p className="mt-6 mx-auto max-w-xl text-lg text-slate-300">
              Acompaño a familias y desarrolladores en mensuras, subdivisiones y relevamientos complejos,
              garantizando cumplimiento normativo y tiempos de respuesta eficientes.
            </p>
